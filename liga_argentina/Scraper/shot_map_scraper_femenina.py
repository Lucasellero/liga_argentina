...
"""
Liga Femenina Basketball - Shot Map Scraper

Usage:
    python shot_map_scraper_femenina.py               # Scrape all new games
    python shot_map_scraper_femenina.py --full        # Re-scrape everything
    python shot_map_scraper_femenina.py --dry-run     # List games, no fetch
"""
...
OUTPUT_CSV = DOCS_DIR / "liga_femenina_shots.csv"
