#!/usr/bin/env python3
"""
Liga Femenina Basketball - Play-by-Play Scraper

Scrapes jugada-a-jugada data from the "En vivo" section.

Usage:
    python pbp_scraper_femenina.py               # Scrape all new games
    python pbp_scraper_femenina.py --full        # Re-scrape everything
    python pbp_scraper_femenina.py --dry-run     # List games, no fetch
    python pbp_scraper_femenina.py --output path.csv
"""
...
DOCS_DIR   = Path(__file__).parent.parent / "docs" / "liga_femenina"
INPUT_CSV  = DOCS_DIR / "liga_femenina.csv"
OUTPUT_CSV = DOCS_DIR / "liga_femenina_pbp.csv"
...
# ---------------------------------------------------------------------------
def main():
    parser = argparse.ArgumentParser(description="Liga Femenina play-by-play scraper")
