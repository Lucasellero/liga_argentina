...
"""
Liga de Desarrollo (Liga Próximo) - Shot Map Scraper

Usage:
    python shot_map_scraper_proximo.py               # Scrape all new games
    python shot_map_scraper_proximo.py --full        # Re-scrape everything
    python shot_map_scraper_proximo.py --dry-run     # List games, no fetch
"""
...
OUTPUT_CSV = DOCS_DIR / "liga_proximo_shots.csv"
