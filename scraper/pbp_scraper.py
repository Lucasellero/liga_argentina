#!/usr/bin/env python3
"""
Liga Argentina Basketball - Play-by-Play Scraper

Scrapes jugada-a-jugada data from the "En vivo" section.

Usage:
    python pbp_scraper.py               # Scrape all new games
    python pbp_scraper.py --full        # Re-scrape everything
    python pbp_scraper.py --dry-run     # List games, no fetch
    python pbp_scraper.py --output path.csv
"""
...
OUTPUT_CSV = DOCS_DIR / "liga_argentina_pbp.csv"
...
# ---------------------------------------------------------------------------
def main():
    parser = argparse.ArgumentParser(description="Liga Argentina play-by-play scraper")
