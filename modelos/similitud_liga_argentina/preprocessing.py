"""
preprocessing.py — Carga y agrega el CSV de Liga Argentina a nivel jugador-temporada.
"""

import pandas as pd

import os as _os
CSV_PATH = _os.path.join(_os.path.dirname(__file__), "..", "docs", "liga_argentina.csv")
