...
const CSV_PATH = SEASON_DIR + 'liga_femenina.csv';
...
(function renderSeasonToggle() {
  ...
  if (sub) sub.textContent = 'Liga Femenina · ' + (SEASON === '2025-26' ? 'Temporada 2025/26 (archivada)' : 'Serie Regular 2026/2027');
})();
let DOB_MAP = {};
...
// ── SHOTS DATA ──────────────────────────────────────
const SHOTS_CSV = SEASON_DIR + 'liga_femenina_shots.csv';
...
const PBP_CSV = SEASON === '2025-26'
  ? SEASON_DIR + 'liga_femenina_pbp.csv'
  : 'https://repsndqhmyklxukffovf.supabase.co/storage/v1/object/public/pbp/liga_femenina_pbp.csv';
